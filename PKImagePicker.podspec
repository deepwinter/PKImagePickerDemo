#
#  Be sure to run `pod spec lint PKImagePicker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "pavankris" => "pavankris@gmail.com" }
  # Or just: s.author    = "pavankris"
  # s.authors            = { "pavankris" => "pavankris@gmail.com" }
  s.social_media_url   = "http://twitter.com/pavankris"
